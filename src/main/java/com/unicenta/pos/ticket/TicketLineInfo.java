 ...
 * @author adrianromero
 */
public class TicketLineInfo implements SerializableRead, Serializable {
  ...
  public TicketLineInfo(
    ...
    props.setProperty(
        "product.printer", productprinter); // added to props as may introduce printer redirect
